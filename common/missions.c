...
MISSIONS g_missions[]= {
    ...
    [MISSION_CONQWORLD] = {.player_number=0,
        .name=N_("Conquer the world"),
        .continents={[CONTINENTE_AMERICASUR]=CONT_AMERICASUR_CANT,
    ...
    [MISSION_COMMON] = {.player_number=0,
        ...
        .tot_countries=30 },
    {
        ...
        .continents={[CONTINENTE_AMERICASUR]=0,
...

    {
        ...
        .continents={[CONTINENTE_AMERICASUR]=2,
                     [CONTINENTE_AMERICANORTE]=0,
                     [CONTINENTE_AFRICA]=0,
                     [CONTINENTE_OCEANIA]=0,
                     [CONTINENTE_EUROPA]=0,
